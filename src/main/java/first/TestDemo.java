...
//        InputStream inputStream = TestDemo.class.getResourceAsStream("/test.properties");
        InputStream ips = new FileInputStream("./test.properties");

        properties.load(ips);
//        properties.load(TestDemo.class.getResourceAsStream(".\\test.properties"));
...
//        System.setProperty("webdriver.http.factory", "apache");
        ...
        System.out.println("@Before：链接成功...");
    }
...
//            TommyTestUtils.delay(driver,6);  //可以等待 也可以 判断
    ...
    public void tearDown() {
        ...
        System.out.println("@After:tearDown;结束");
    }
}
