...
public class SendMsgs extends AppiumTestBase {
    @Test
    public void FaHangQing() {
...
//        点击表情坐标
        touchAction.press(PointOption.point(420, 1560)).release().perform();
//        发送
...
//        长按说话
        touchAction.press(PointOption.point(406, 1419)).release().perform();
